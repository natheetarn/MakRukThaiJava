...
public class Board {
    ...
    void setStartingPiecesBlack(boolean isHostView) {
        if (isHostView) {
            ...
            // ่knight
            board[getOpposite(7)][getOpposite(1)].setPiece(new RuaPiece(Color.BLACK));
            board[getOpposite(7)][getOpposite(6)].setPiece(new RuaPiece(Color.BLACK));

            // cone
            board[getOpposite(7)][getOpposite(2)].setPiece(new RuaPiece(Color.BLACK));
            board[getOpposite(7)][getOpposite(5)].setPiece(new RuaPiece(Color.BLACK));
            ...
            board[7][1].setPiece(new RuaPiece(Color.BLACK));
            board[7][6].setPiece(new RuaPiece(Color.BLACK));

            board[7][2].setPiece(new RuaPiece(Color.BLACK));
            board[7][5].setPiece(new RuaPiece(Color.BLACK));

            board[7][3].setPiece(new KhunPiece(Color.BLACK));
            board[7][4].setPiece(new RuaPiece(Color.BLACK));
        }
    }
